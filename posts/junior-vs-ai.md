...
Yet one group of engineers continues to struggle in the job market. Many argue that AI has made them obsolete: junior developers.
...
In a sense I might even agree with some people who claim that AI already replaced "Junior Engineers". What we actually disagree on is the term "Junior Engineer". They use it to describe a not very competent engineer, which - as i`ve laid out - is very different to having a junior title.
